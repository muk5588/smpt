...
public class TipController {
	...
	public String list(
	    ...
	    logger.info("/Tip/tiplist [GET]");
	    logger.info("/Tip/tiplist search : {}", search);
	    logger.info("/Tip/tiplist searchKind : {}", searchKind);
	    logger.info("/Tip/tiplist categoryNo : {}", categoryNo);
		String URL = "/tip/tiplist";
	    // 페이징 계산
...
//	        logger.debug("M : {}", M.toString());
	...
	public String writeProc(
		...
		// 다중 이미지 출력
		 ...
		 return "redirect:/tip/tiplist?categoryNo=" + categoryNo; // 글작성 시 선택한 카테고리 목록으로 이동.
	}
	 ...
	 @GetMapping("/update")
	    ...
	    public String updateProc(
	        ...
	        if (res > 0) {
	            ...
	            return "redirect:/tip/view?boardNo=" + board.getBoardNo(); // 해당 글 상세페이지로 이동
	        }
	        return "redirect:/tip/view?boardNo=" + board.getBoardNo(); // 해당 글 상세페이지로 이동
	    }
