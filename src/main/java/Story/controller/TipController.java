...
public class TipController {
	...
	public String list(
	    ...
	    logger.info("/tip/list [GET]");
	    logger.info("/tip/list search : {}", search);
	    logger.info("/tip/list searchKind : {}", searchKind);
	    logger.info("/tip/list categoryNo : {}", categoryNo);
		String URL = "/tip/list";
	    // 페이징 계산
...
//			for( )
		 ...
		 return "redirect:/tip/list?categoryNo=" + categoryNo; // 글작성 시 선택한 카테고리 목록으로 이동.
	}
