...
<script type="text/javascript">
	...
	var sUploadURL = '/photo/fileupload';
</script>
...
<body>
	...
	<div class="container">
		...
		<form action="./update" method="post" id="updateForm" enctype="multipart/form-data">
			<div hidden="hidden">
				<input type="text" class="form-control" id="boardNo" hidden="hidden" name="boardNo" value="${photo.boardNo }">
			</div>
			<div class="mb-3">
			...
			<div class="mb-3">
				...
				<input type="text" class="form-control" id="title" name="title" style="width: 100%;height: 5%" value="${photo.title }">
			</div>
			<div class="mb-3">
