...
<form action="./update" method="post" id="writeFrom" enctype="multipart/form-data">
...
<!--         </select> -->
    ...
    <div class="mb-3">
        <label for="itemName" class="form-label">상품이름</label>
        <input type="text" class="form-control" id="itemName" value="${item.itemName }" placeholder="상품 명을 적어주세요" name="itemName">
    </div>
    <div class="mb-3">
        <label for="price" class="form-label">상품가격</label>
        <input type="number" class="form-control" id="price" value="${item.price }" placeholder="가격을 적어주세요" name="price">
    </div>
    <div class="mb-3">
        <label for="remain" class="form-label">상품재고</label>
        <input type="number" class="form-control" id="remain" value="${item.remain }" placeholder="재고 수를적어주세요" name="remain">
    </div>
...
<div id="se2_sample" style="margin:10px 0;">
    ...
    <input type="text" class="form-control" id="itemNo" hidden="hidden" name="itemNo" value="${item.itemNo }">
