 <%@ page contentType="text/html;charset=UTF-8" language="java" %>
    ...
    <ul class="nav">
        ...
        <li>
    		<li><a href="/photo/list?categoryNo=21&curPage=${curPage}">
        ...
        <li class="menu">
            ...
            <ul>
	            <li><a href="/qanda/list?categoryNo=41&curPage=${curPage}">꿀팁게시판</a></li>
	            <li><a href="/Free/list?categoryNo=42&curPage=${curPage}">자유게시판</a></li>
	            <li><a href="/notice/list?categoryNo=43&curPage=${curPage}">공지사항</a></li>
            </ul>
        </li>
        <li class="menu">
