		...
		<div class="container">
			...
			<table class="table table-striped table-hover table-sm">
				...
				<tr>
					...
					<td class="content">${board.content }<!-- 첨부된 파일을 보여주는 부분 추가 -->
					...
					<td class="date"><fmt:formatDate value="${board.createDate }"
			...
			<c:if test="${isLogin > 0}">
				...
				<button
					onclick="location.href='../report/boardReport?categoryNo=${param.categoryNo}&boardno=${board.boardNo}'">
					신고하기</button>
			</c:if>
			<hr>
			<div class="comment">
